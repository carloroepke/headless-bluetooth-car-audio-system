...
class hasher(object):
   ...
   IR remote. The remote key press is not converted into a code in the manner of
   ...
   keys and different remotes but this is not guaranteed. This hashing process works for some remotes/protocols but not for
